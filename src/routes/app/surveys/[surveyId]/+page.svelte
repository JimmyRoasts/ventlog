...
<section class="space-y-6">
	<div class="flex items-center justify-between gap-3">
		...
		<Button href="/app/surveys" variant="outline">Back to surveys</Button>
	</div>
				...
				<Dialog.Root bind:open={createReadingOpen}>
					...
					<Dialog.Content>
						...
						>
							...
							<div class="grid gap-4 sm:grid-cols-2">
								<div class="space-y-2">
									<label class="text-sm font-medium text-foreground" for="reading-dry">Dry bulb (°C)</label>
									<Input id="reading-dry" name="dryBulbC" type="number" step="0.1" required />
								</div>
								<div class="space-y-2">
									<label class="text-sm font-medium text-foreground" for="reading-wet">Wet bulb (°C)</label>
								...
								<div class="space-y-2">
									<label class="text-sm font-medium text-foreground" for="reading-vel">Air velocity (m/s)</label>
									<Input id="reading-vel" name="airVelocityMs" type="number" step="0.1" />
								</div>
								<div class="space-y-2">
									<label class="text-sm font-medium text-foreground" for="reading-static">Static pressure (Pa)</label>
								...
								<div class="space-y-2">
									...
									<Input id="reading-barometric" name="barometricPressureKpa" type="number" step="0.01" />
								</div>
								<div class="space-y-2">
								...
								<div class="space-y-2 sm:col-span-2">
									<label class="text-sm font-medium text-foreground" for="reading-remarks">Remarks</label>
					...
					{:else}
						{#each data.survey.readings as reading}
							<tr class="align-top hover:bg-muted/50 [&>td]:px-4 [&>td]:py-3">
								...
								<td class="text-right text-muted-foreground">{formatNumber(reading.airVelocityMs, 1)}</td>
								<td class="text-right text-muted-foreground">{formatNumber(reading.staticPressurePa, 1)}</td>
								<td class="text-right text-muted-foreground">
								...
								<td class="text-right">
									<div class="flex justify-end gap-2">
										<Dialog.Root
											...
											onOpenChange={(open) =>
												(activeEditReadingId =
													open ? reading.id : activeEditReadingId === reading.id ? null : activeEditReadingId)}
										>
											<Dialog.Trigger>
												{#snippet child({ props })}
													<Button size="icon" variant="outline" aria-label="Edit reading" {...props}>
											...
											<Dialog.Content>
												...
												>
													...
													<div class="grid gap-4 sm:grid-cols-2">
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`node-${reading.id}`}>
																Node
															</label>
															<select
																id={`node-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`idx-${reading.id}`}>
																Reading #
															</label>
															<Input
																id={`idx-${reading.id}`}
													...
													<div class="grid gap-4 sm:grid-cols-2">
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`dry-${reading.id}`}>
																Dry bulb (°C)
															</label>
															<Input
																id={`dry-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`wet-${reading.id}`}>
																Wet bulb (°C)
															</label>
															<Input
																id={`wet-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`rh-${reading.id}`}>
																RH (%)
															</label>
															<Input
																id={`rh-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`vel-${reading.id}`}>
																Air velocity (m/s)
															</label>
															<Input
																id={`vel-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`static-${reading.id}`}>
																Static pressure (Pa)
															</label>
															<Input
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`baro-${reading.id}`}>
																Barometric pressure (kPa)
															</label>
															<Input
																id={`baro-${reading.id}`}
														...
														<div class="space-y-2">
															<label class="text-sm font-medium text-foreground" for={`inst-${reading.id}`}>
																Instrument ID
															</label>
															<Input
																id={`inst-${reading.id}`}
														...
														<div class="space-y-2 sm:col-span-2">
															<label class="text-sm font-medium text-foreground" for={`remarks-${reading.id}`}>
																Remarks
															</label>
															<Textarea
										...
										<Dialog.Root
											...
											onOpenChange={(open) =>
												(activeDeleteReadingId =
													open ? reading.id : activeDeleteReadingId === reading.id ? null : activeDeleteReadingId)}
										>
											<Dialog.Trigger>
												{#snippet child({ props })}
													<Button size="icon" variant="outline" aria-label="Delete reading" {...props}>
