...
<section class="space-y-6">
	<div class="flex flex-col gap-2">
		<div class="flex flex-wrap items-center justify-between gap-3">
			<div>
				<h1 class="text-2xl font-semibold text-foreground">Survey points for {data.mine.name}</h1>
				<p class="text-sm text-muted-foreground">
					Define survey points in the mine where ventilation readings are taken.
				</p>
			</div>
										...
										>
											...
											<Dialog.Content>
												<Dialog.Header>
													...
													<Dialog.Description>
														This will remove the survey point and any associated survey readings.
													</Dialog.Description>
												</Dialog.Header>
												<form
													method="POST"
